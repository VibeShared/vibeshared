...
import LikeButton from "@/components/Button compo/LikeButton";
import CommentSection from "@/components/Other/CommentSection";
import DeletePostButton from "@/components/Button compo/DeletePostButton";
...
import ShareButton from "@/components/Button compo/ShareButton";
    ...
    <div className={`${style.card} card shadow-sm mb-4 border-0`}>
      ...
      <div className="card-body px-3 py-2">
        ...
        <div className="d-flex border-top border-bottom py-2 mb-3">
          ...
          />
          <button
            className="btn btn-sm mb-5  d-flex align-items-center"
