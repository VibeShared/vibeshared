...
import styles from "@/styles/components/Home/AuthButton.module.css";

export default function AuthButton() {
  const { data: session, status} = useSession(); // ✅ update available
      ...
      {open && (
        ...
        >
          ...
          <button
            ...
            className="dropdown-item d-flex align-items-center py-2 text-danger ms-3"
          >
